        ...
        <section className='cart__wrapper' >
            <section className='cart'>
                <div className='cart__icon__wrapper'>
                    <i onClick={() => { closeCart() }} className="fa-regular fa-circle-xmark cart__icon"></i>
                </div>
                ...
                </div>
                {
                    hasProducts
                        ...
                        <>
                            ...
                            <button className='cart__card__send__button' onClick={() => { sendOrderHandler() }}>Send order</button>
                        </>
                        : null
                }
            </section>
